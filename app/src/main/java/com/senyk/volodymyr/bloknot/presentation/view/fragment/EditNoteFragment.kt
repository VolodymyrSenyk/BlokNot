...
import com.senyk.volodymyr.bloknot.databinding.FragmentEditNoteBinding
...
import com.senyk.volodymyr.bloknot.presentation.viewmodel.model.EditNoteViewModel
import com.senyk.volodymyr.bloknot.presentation.viewmodel.util.AttrValuesProvisionUtil
import kotlinx.android.synthetic.main.fragment_edit_note.*

class EditNoteFragment : BaseCryptoNotepadFragment(),
    ...
    override val layoutRes = R.layout.fragment_edit_note
    override val toolbarRes = R.layout.toolbar_edit_note
    override val menuRes = R.menu.menu_edit_note
    override val viewModel by viewModels<EditNoteViewModel>(factoryProducer = { viewModelFactory })
