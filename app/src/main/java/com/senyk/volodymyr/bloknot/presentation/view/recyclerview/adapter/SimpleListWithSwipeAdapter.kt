...
import com.senyk.volodymyr.bloknot.presentation.view.recyclerview.viewholder.SimpleDataListItemWithSwipeViewHolder
...
open class SimpleListWithSwipeAdapter(
    ...
    override fun getItemViewType(position: Int): Int =
        when (getItem(position)) {
            ...
            is SimpleDataListItem -> R.layout.list_item_with_swipe
    ...
    override fun onCreateViewHolder(
        ...
        when (viewType) {
            ...
            R.layout.list_item_with_swipe -> {
                SimpleDataListItemWithSwipeViewHolder(
                    parent = parent,
