...
import com.senyk.volodymyr.bloknot.presentation.view.fragment.NoteDetailsFragmentDirections
...
class NoteDetailsViewModel @Inject constructor(
    ...
    fun onEditNoteClick() {
        note.value?.id?.let { noteId ->
            val action =
                NoteDetailsFragmentDirections.actionNoteDetailsFragmentToEditNoteFragment(noteId = noteId)
